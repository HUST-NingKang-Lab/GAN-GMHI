...
#new_file <- "./final.csv"
#MH_species_file <- "./MH_species.csv"
#MN_species_file <- "./MN_species.csv"
#output_file = 'GMHI_output.csv'
#------------------------------------------------------
setwd("D:/GMHI/data")

species_relative_abundance_file <- "./species_relative_abundance.csv"
new_file <- "./final.csv"
MH_species_file <- "./H_species.csv"
MN_species_file <- "./NH_species.csv"
output_file = 'val_output.csv'
...
MH_species_metagenome <- species_profile_3[row.names(species_profile_3) %in% H_species, ]
MN_species_metagenome <- species_profile_3[row.names(species_profile_3) %in% NH_species, ]
