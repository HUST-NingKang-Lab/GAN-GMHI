...
Healthy_accuracy <- sum(filter(fig6_alpha_GMHI_data_final,Phenotype=='Healthy')$GMHI>-0.59)*100/118
Nonhealthy_accuracy <- sum(filter(fig6_alpha_GMHI_data_final,Phenotype=='Unhealthy')$GMHI< -0.59)*100/561
total_accuracy <- (Healthy_accuracy+Nonhealthy_accuracy)/2
overage_accuracy<-(sum(filter(fig6_alpha_GMHI_data_final,Phenotype=='Healthy')$GMHI>-0.59)+sum(filter(fig6_alpha_GMHI_data_final,Phenotype=='Unhealthy')$GMHI< -0.59))*100/679
